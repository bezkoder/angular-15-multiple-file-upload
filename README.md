# Angular 15 Multiple File upload example with Progress bar

Build an Angular 15 Multiple File upload example using Bootstrap, Multipart File, FormData and Progress Bar in that user can:
...
![angular-15-multiple-file-upload-example](angular-15-multiple-file-upload-example.png)

For more detail, please visit:
> [Angular 15 Multiple File upload example with Progress bar & Bootstrap](https://www.bezkoder.com/angular-15-multiple-file-upload/)
